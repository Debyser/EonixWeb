...
namespace WebApi.Controllers
{
    ...
    public class AddressController : ControllerBase
    {
        ...
        public async Task<IActionResult> ModifyAddress([FromRoute] int id, [FromBody] AddressView addressDto)
        {
        ...
        public async Task<IActionResult> CreateAddress([FromBody] AddressView Address)
        ...
        public async Task<IActionResult> GetAddressById([FromRoute] int id)
            => Ok(_mapper.Map<AddressView>(await _addressService.GetByIdAsync(id)));
